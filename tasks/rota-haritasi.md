...
| **Bugün R2'de yayında** | **129** | %87,2 | 97 |
| **Kalan** | **19** | %12,8 | 51 |

> **13 Ağustos · Dilim 7 KAPANIŞI — rota 62 ve 63 kapandı.** Kalan 19 satırın
> **18'i BLOKE** (yazma yordamı yok · V2-98 · V2-99), **1'i KAPSAM DIŞI**
> (66 · ADR-R2-03). **Gerçek iş kalmadı.** Ölçüm: 148 benzersiz satır ·
> 129 ✅ · 18 ⛔ · 1 kapsam dışı.
...
| 23 | `app-onanaliz-form.html` | **GÖMÜLÜYOR** | → drawer · ⚠️ **YAZILMADI**: ön analiz OLUŞTURMA yüzeyi bu dilimde açılmadı, okuma ve durum ilerletme var. V2 borcu (`tasks/v2-borc.md` V2-04) | · ⛔ **BLOKE — yazma yordamı yok.** `DB.analyses` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 29 | `app-komisyon-form.html` | **GÖMÜLÜYOR** ✔ | → drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.commissions` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 35 | `app-proje-sprint-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.sprints` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 38 | `app-proje-test-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.testCases` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 41 | `app-proje-hata-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.bugs` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 44 | `app-proje-degisiklik-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.changeRequests` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 47 | `app-proje-teslim-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.deliveries` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 53 | `app-istalebi-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.deptRequests` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 62 | `app-toplanti.html` | **GÖMÜLÜYOR** | panel takvimi + müşteri/proje detayı aktivitesi | ✅ **GÖMÜLDÜ** → üç ayak: `app-panel.html` "Günün ajandası" (zaten yayındaydı, dokunulmadı) + `app-musteri-detay.html` › Aktivite › **Toplantılar** + `app-proje-detay.html` › Aktivite › **Toplantılar**. Ölçüldü: `DB.meetings` 9 kayıt, **5'inde `musteri` ve aynı 5'inde `proje` dolu**; kalan 4 departman/satış toplantısı hiçbir bağlama düşmez ve bu ekranda YAZILI. |
| 63 | `app-toplanti-detay.html` | **GÖMÜLÜYOR** | bağlamsal aktivite kaydı | ✅ **GÖMÜLDÜ** → toplantının tamamı (tür · tarih · süre · yer · gündem · katılımcı · dış katılımcı · durum) bağlam satırında basılır, ayrı detay yüzeyi açılmaz. **Rozet YOK**: `tur` ve `durum` için sözlük koleksiyonu ölçülmedi, sözlüksüz alana rozet §22.17.12 ihlalidir. **"Toplantı ekle" düğmesi YOK** ve sebebi ekranda yazılı (rota 64 bloke · V2-99). Dış katılımcı satırı boş dizide BASILMAZ. |
| 64 | `app-toplanti-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.meetings` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 85 | `app-performans-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.performance` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 102 | `app-arac-bakim-form.html` | **GÖMÜLÜYOR** → drawer | · ⛔ **BLOKE — yazma yordamı yok.** Araç alt defterine kayıt EKLEYEN yordam ortak katmanda yok (ölçüldü). **Beyar kararı (13 Ağustos):** yazma yordamı YAZILMAYACAK, kapsam donduruldu; kapsam donduruldu. **Yüzey:** salt okunur çekmece açıldı — kaydetme düğmesi gizlenmez, **devre dışı bırakılır** ve sebebi ekranda yazılır. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-98**
...
| 104 | `app-arac-muayene-form.html` | **GÖMÜLÜYOR** → drawer | · ⛔ **BLOKE — yazma yordamı yok.** Araç alt defterine kayıt EKLEYEN yordam ortak katmanda yok (ölçüldü). **Beyar kararı (13 Ağustos):** yazma yordamı YAZILMAYACAK, kapsam donduruldu; kapsam donduruldu. **Yüzey:** salt okunur çekmece açıldı — kaydetme düğmesi gizlenmez, **devre dışı bırakılır** ve sebebi ekranda yazılır. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-98**
...
| 106 | `app-arac-sigorta-form.html` | **GÖMÜLÜYOR** → drawer | · ⛔ **BLOKE — yazma yordamı yok.** Araç alt defterine kayıt EKLEYEN yordam ortak katmanda yok (ölçüldü). **Beyar kararı (13 Ağustos):** yazma yordamı YAZILMAYACAK, kapsam donduruldu; kapsam donduruldu. **Yüzey:** salt okunur çekmece açıldı — kaydetme düğmesi gizlenmez, **devre dışı bırakılır** ve sebebi ekranda yazılır. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-98**
...
| 108 | `app-arac-yakit-form.html` | **GÖMÜLÜYOR** → drawer | · ⛔ **BLOKE — yazma yordamı yok.** Araç alt defterine kayıt EKLEYEN yordam ortak katmanda yok (ölçüldü). **Beyar kararı (13 Ağustos):** yazma yordamı YAZILMAYACAK, kapsam donduruldu; kapsam donduruldu. **Yüzey:** salt okunur çekmece açıldı — kaydetme düğmesi gizlenmez, **devre dışı bırakılır** ve sebebi ekranda yazılır. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-98**
...
| 110 | `app-arac-gider-form.html` | **GÖMÜLÜYOR** → drawer | · ⛔ **BLOKE — yazma yordamı yok.** Araç alt defterine kayıt EKLEYEN yordam ortak katmanda yok (ölçüldü). **Beyar kararı (13 Ağustos):** yazma yordamı YAZILMAYACAK, kapsam donduruldu; kapsam donduruldu. **Yüzey:** salt okunur çekmece açıldı — kaydetme düğmesi gizlenmez, **devre dışı bırakılır** ve sebebi ekranda yazılır. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-98**
...
| 112 | `app-arac-kaza-form.html` | **GÖMÜLÜYOR** → drawer | · ⛔ **BLOKE — yazma yordamı yok.** Araç alt defterine kayıt EKLEYEN yordam ortak katmanda yok (ölçüldü). **Beyar kararı (13 Ağustos):** yazma yordamı YAZILMAYACAK, kapsam donduruldu; kapsam donduruldu. **Yüzey:** salt okunur çekmece açıldı — kaydetme düğmesi gizlenmez, **devre dışı bırakılır** ve sebebi ekranda yazılır. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-98**
...
| 119 | `app-siparis-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.orders` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
...
| 122 | `app-tedarikci-form.html` | **GÖMÜLÜYOR** | drawer | · ⛔ **BLOKE — yazma yordamı yok.** `DB.suppliers` defterine kayıt EKLEYEN yordam ortak katmanda YOK (13 Ağustos, ajan açılmadan ÖNCE ölçüldü; iki yönlü sınandı). Kaydetmesi olmayan drawer basmak §14.6 "sahte buton" yasağının form ölçeğidir. **Beyar kararı (13 Ağustos):** V2-98'in salt okunur çekmece kararı bu satıra UZATILMADI, kapsam donduruldu. **Yüzey:** açılmadı — bu satırın ne yazma ne salt okunur bir yüzeyi var. Satır KAPATILMADI. Borç: `v2-borc.md` **V2-99**
